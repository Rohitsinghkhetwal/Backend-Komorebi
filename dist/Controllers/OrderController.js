...
var BASE_UNIT = 100;
var getTotalAmount = function (orderItem) {
    return (orderItem.reduce(function (acc, items) { return acc + items.price * items.quantity; }, 0) * BASE_UNIT);
};
var createOrder = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, user, deliveryAddress, orderItem, totalPrice, totalAmount, paymentIntent, result, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = request.body, user = _a.user, deliveryAddress = _a.deliveryAddress, orderItem = _a.orderItem, totalPrice = _a.totalPrice;
                totalAmount = getTotalAmount(orderItem);
            ...
            case 3:
                error_1 = _b.sent();
                console.log("Something went wrong_________!", error_1);
                response.send({
